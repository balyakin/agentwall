...
var BuiltinPatterns = []PatternDef{
	...
	{ID: "google_api_key", Pattern: `\bAIza[0-9A-Za-z\-_]{35}\b`, Replacement: "***REDACTED:GOOGLE_API_KEY***", HighConfidence: true},
	...
	{ID: "generic_secret_assignment", Pattern: `(?mi)((?:^|[\s"'])(?:[A-Za-z0-9_.-]*?(?:secret|token|password|passwd|api[_-]?key|private[_-]?key)[A-Za-z0-9_.-]*?)\s*[:=]\s*["']?)([^\s"'#]{8,})(["']?)`, Replacement: `${1}***REDACTED:GENERIC_SECRET***${3}`},
